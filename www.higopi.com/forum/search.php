...
<title>HiGopi Forum / Search</title>
					...
					<div class="infldset">
						<label class="conl">Forum						<br /><select id="forum" name="forum">
							...
							<optgroup label="Technical">
								<option value="5">IT Jobs in India</option>
								<option value="2">Technical Doubts</option>
								<option value="4">Java Technology</option>
								<option value="3">Indian Language Software</option>
							</optgroup>
						...
						<br /></label>
						<label class="conl">Search in						<br /><select id="search_in" name="search_in">
						...
						<br /></label>
						<p class="clearb">Choose in which forum you would like to search and if you want to search in topic subjects, message text or both.</p>
					</div>
				</fieldset>
			</div>
			<div class="inform">
				<fieldset>
					...
					<div class="infldset">
						...
						<br /></label>
						<label class="conl">Show results as						<br /><select name="show_as">
